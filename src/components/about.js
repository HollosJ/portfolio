...
const About = () => {
  return (
    <div id="about" className="container max-w-4xl px-4 mx-auto scroll-mt-12 ">
      <h1 className="my-4 md:my-8 header">About me</h1>
      <div className="md:text-xl">
        ...
        <p className="mt-4 mb-8">
          ...
          advice company. Here I am using such technologies as Tailwind,
          Alpine.js, WordPress and PHP.
        </p>
      </div>
    </div>
  );
